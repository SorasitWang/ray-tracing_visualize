...
public :
	...
	glm::vec3 min, max;
	glm::mat4 t, r, s, trs, invTrs,position;
	Material material;
	Object() {
		this->VAO = 0;
		this->VBO = 0;
	...
	void setMaterial(string type, const glm::vec3& val);
	...
	void drawPhong(const vector<PointLight*>* pointLights, const glm::vec3& viewPos, const glm::mat4& projection, const glm::mat4& view, bool drawShadow=false);
	virtual void draw()=0;
